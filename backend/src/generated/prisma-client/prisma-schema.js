...
type ImagePostConnection {
  pageInfo: PageInfo!
  edges: [ImagePostEdge]!
  aggregate: AggregateImagePost!
}
...
type ImagePostSubscriptionPayload {
  mutation: MutationType!
  node: ImagePost
  updatedFields: [String!]
...
input ImagePostSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ImagePostWhereInput
  AND: [ImagePostSubscriptionWhereInput!]
  OR: [ImagePostSubscriptionWhereInput!]
  NOT: [ImagePostSubscriptionWhereInput!]
}
...
input ImagePostUpdateManyWithoutUserInput {
  create: [ImagePostCreateWithoutUserInput!]
  delete: [ImagePostWhereUniqueInput!]
  connect: [ImagePostWhereUniqueInput!]
  set: [ImagePostWhereUniqueInput!]
  disconnect: [ImagePostWhereUniqueInput!]
  update: [ImagePostUpdateWithWhereUniqueWithoutUserInput!]
  upsert: [ImagePostUpsertWithWhereUniqueWithoutUserInput!]
  deleteMany: [ImagePostScalarWhereInput!]
  updateMany: [ImagePostUpdateManyWithWhereNestedInput!]
}

input ImagePostUpdateManyWithWhereNestedInput {
...
input ImagePostWhereInput {
  ...
  AND: [ImagePostWhereInput!]
  OR: [ImagePostWhereInput!]
  NOT: [ImagePostWhereInput!]
}

input ImagePostWhereUniqueInput {
  id: ID
}
...
type Mutation {
  ...
  createImagePost(data: ImagePostCreateInput!): ImagePost!
  updateImagePost(data: ImagePostUpdateInput!, where: ImagePostWhereUniqueInput!): ImagePost
  updateManyImagePosts(data: ImagePostUpdateManyMutationInput!, where: ImagePostWhereInput): BatchPayload!
  upsertImagePost(where: ImagePostWhereUniqueInput!, create: ImagePostCreateInput!, update: ImagePostUpdateInput!): ImagePost!
  deleteImagePost(where: ImagePostWhereUniqueInput!): ImagePost
  deleteManyImagePosts(where: ImagePostWhereInput): BatchPayload!
...
type Query {
  ...
  imagePost(where: ImagePostWhereUniqueInput!): ImagePost
  ...
  imagePostsConnection(where: ImagePostWhereInput, orderBy: ImagePostOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ImagePostConnection!
...
input UserCreateOneWithoutImagePostsInput {
...
input UserUpdateOneRequiredWithoutImagePostsInput {
  create: UserCreateWithoutImagePostsInput
...
input UserUpsertWithoutImagePostsInput {
  update: UserUpdateWithoutImagePostsDataInput!
  create: UserCreateWithoutImagePostsInput!
}
